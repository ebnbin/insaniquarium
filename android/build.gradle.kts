...
dependencies {
    ...
    natives(Dependency.GDX_BOX2D_PLATFORM_NATIVES_ARMEABI_V7A)
    natives(Dependency.GDX_BOX2D_PLATFORM_NATIVES_ARM64_V8A)
    natives(Dependency.GDX_BOX2D_PLATFORM_NATIVES_X86)
    natives(Dependency.GDX_BOX2D_PLATFORM_NATIVES_X86_64)
