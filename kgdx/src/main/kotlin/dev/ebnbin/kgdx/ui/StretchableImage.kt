...
class StretchableImage(textureAsset: TextureAsset, getAssetBlocked: Boolean = false) : Widget() {
    ...
    private val texture: Texture = textureAsset.get(blocked = getAssetBlocked)
